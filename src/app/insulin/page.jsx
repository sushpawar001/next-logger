        ...
        const getInsulinData = async () => {
            try {
                ...
                if (response.status === 200) {
                    setInsulinData(response.data.data);
                }
                else {
                    ...
                    <div className='flex flex-wrap'>
                        <div className='max-w-full overflow-x-auto rounded-lg'>
                            <div className='mb-2 grid grid-cols-2'>
                                <h3 className='my-auto ml-1 text-lg font-medium text-gray-900'>Insulin History</h3>
                            ...
                            <table className='table-auto'>
                                <thead className='text-center bg-secondary'>
                                    <tr>
                                        <th className={`${TdStyle.ThStyle} rounded-tl-lg`}> Blood Insulin </th>
                ...
                >
                    ...
                    <div className="-mx-3 flex flex-wrap">
                        <div className="w-1/2 px-3">
                            <button className="block w-full rounded-xl border-primary-dark bg-primary p-3 text-center text-base font-medium text-white transition hover:bg-primary-dark" onClick={() => setModalOpen(false)}>
                                Cancel
                            </button>
                        </div>
                        <div className="w-1/2 px-3">
                            <button
                                className="block w-full rounded-xl bg-red-600 border border-stroke p-3 text-center text-base font-medium transition hover:border-red-800 hover:bg-red-800 text-white" onClick={() => {
                                    props.delete()
                                    setModalOpen(false)
                                }}
                            >

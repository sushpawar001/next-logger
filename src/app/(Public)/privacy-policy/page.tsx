        ...
        <div className="hero-gradient">
            <div className="h-[40vh] lg:h-[60vh] py-2.5 lg:py-5">
                <div className="container flex flex-col h-full px-6 md:px-0">
                    <div className="py-2.5 flex justify-between shrink-0">
                        ...
                        <div className="flex gap-1.5 md:gap-4">
                            <div>
                                <Link href="/login">
                                    <button
                                        className="rounded-md md:rounded-lg px-5 lg:my-auto py-1 lg:py-2 text-sm lg:text-base font-semibold text-secondary transition  duration-500 h-full w-full hover:scale-105 hover:border-primary hover:text-primary-dark hover:outline"
                                        onClick={null}
                                    >
                                        Log in
                                    </button>
                    ...
                    <div className="h-full flex grow text-center items-center justify-center">
                        <div>
            ...
            <div className="hero-gradient-reverse p-2.5 lg:px-0 lg:py-5 leading-loose text-wrap">
                <div className="max-w-screen-xl mx-auto drop-shadow-xl rounded-lg -mt-16 md:-mt-28">
                    <div className="bg-white p-5 md:p-7 rounded-lg">
                        ...
                        <ul className="list-disc list-outside p-7">
                            ...
                            <li>
                                ...
                                website or any social network website through
                                which a User can log in or create an account to
                                use the Service.
                            </li>
                            <li>
                            ...
                            <li>
                                Website refers to FitDose, accessible from{" "}
                                <a
                                    href="http://fitdose.fitnationplus.com/"
                                    rel="external nofollow noopener"
                                    target="_blank"
                                >
                                    http://fitdose.fitnationplus.com/
                                </a>
                            </li>
                            <li>
                        ...
                        <h4 className="text-lg my-3 underline">
                            Personal Data
                        </h4>
                        ...
                        <h4 className="text-lg my-3 underline">Usage Data</h4>
                        <p>
                        ...
                        <ul className="list-disc list-outside p-7">
                            <li>
                                ...
                                indicate when a Cookie is being sent. However,
                                if You do not accept Cookies, You may not be
                                able to use some parts of our Service. Unless
                                you have adjusted Your browser setting so that
                                it will refuse Cookies, our Service may use
                                Cookies.
                            </li>
                            <li>
                                Web Beacons. Certain sections of our Service and
                                our emails may contain small electronic files
                                known as web beacons (also referred to as clear
                                gifs, pixel tags, and single-pixel gifs) that
                                permit the Company, for example, to count users
                                who have visited those pages or opened an email
                                and for other related website statistics (for
                                example, recording the popularity of a certain
                                section and verifying system and server
                                integrity).
                            </li>
                        </ul>
                        <p>
                        ...
                        <ul className="list-disc list-outside p-7">
                            ...
                            <li>
                                <p>
                                    ...
                                    access to different functionalities of the
                            ...
                            <li>
                                <p>
                                    ...
                                    development, compliance and undertaking of
                            ...
                            <li>
                                <p>
                                    ...
                                    telephone calls, SMS, or other equivalent
                            ...
                            <li>
                                <p>
                                    ...
                                    general information about other goods,
                        ...
                        <ul className="list-disc list-outside p-7">
                            ...
                            <li>
                                ...
                                information for any other purpose with Your
                                consent.
                            </li>
                        </ul>
                        <h3 className="font-semibold text-xl my-2">
            ...
            <div className="bg-primary text-primary-foreground text-center flex flex-col gap-2">
                <div className="container shrink flex justify-between py-3 text-sm lg:text-base w-11/12 lg:w-full">

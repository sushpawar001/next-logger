                    ...
                    <div className='flex flex-wrap'>
                        <div className='max-w-full overflow-x-auto rounded-lg'>
                            <div className='mb-2 grid grid-cols-2'>
                                <h3 className='my-auto ml-1 text-lg font-medium text-gray-900'>Glucose History</h3>
                            ...
                            <table className='table-auto'>
                                <thead className='text-center bg-secondary'>
                                    <tr>
                                        <th className={`${TdStyle.ThStyle} rounded-tl-lg`}> Blood Glucose </th>
                ...
                >
                    ...
                    <div className="-mx-3 flex flex-wrap">
                        <div className="w-1/2 px-3">
                            <button className="block w-full rounded-xl border-primary bg-primary p-3 text-center text-base font-medium text-white transition hover:bg-primary-dark" onClick={() => setModalOpen(false)}>
                                Cancel
                            </button>
                        </div>
                        <div className="w-1/2 px-3">

        ...
        <div className='flex h-full justify-center items-center bg-stone-100 py-10 px-8 md:px-20'>
            <div className="mx-auto w-full max-w-lg rounded-md bg-white px-10 py-16 text-center shadow-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="text-white bg-cyan-600 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-cyan-600 dark:hover:bg-cyan-600 dark:focus:ring-cyan-800">Sign Up</button>
                </form>
            </div>
        </div>
    );

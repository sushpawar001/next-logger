...
export default function SignUp() {
  ...
  return (
    <div className="flex h-full justify-center items-center bg-background py-10 px-5 md:px-20">
      <div className="mx-auto w-full max-w-lg rounded-xl bg-white px-4 md:px-10 py-10 md:py-16 text-center shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="mt-2 text-sm">Already have an account? <a href="/login" className="text-primary">Login</a></p>
        </form>
      </div>
    </div>
  );

            ...
            <div className="flex flex-col max-w-screen-xl mx-auto h-full">
                <div className="grid md:grid-cols-2 gap-2 md:gap-3 h-full">
                    <div className="md:col-span-2 w-full flex gap-2 md:gap-3">
                        <div className="md:w-3/5 rounded-lg flex flex-col gap-0.5 bg-white shadow p-2.5">
                        ...
                        <div className="md:w-2/5 rounded-lg flex gap-2 md:gap-3 bg-white shadow p-2.5">
                    ...
                    <div className="md:col-span-2 w-full p-2.5 md:p-5 rounded-lg bg-white shadow h-96">

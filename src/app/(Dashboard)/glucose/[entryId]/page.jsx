            ...
            <div className='bg-white p-6 rounded-lg shadow w-full max-w-md'>
                <form onSubmit={submitForm}>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <button type="submit" className="text-white bg-primary hover:bg-primary-dark focus:ring focus:outline-none focus:ring-primary-ring font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                    </div>

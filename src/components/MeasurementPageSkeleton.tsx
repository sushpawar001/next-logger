        ...
        <div className="bg-background h-full py-5 px-5">
            <div className="flex flex-col max-w-screen-xl mx-auto">
                <div className="grid md:grid-cols-3 mb-5 gap-5">
                    <form className="max-w-full p-5 md:p-7 rounded-xl bg-white/65 shadow flex items-center justify-center order-2 md:order-1">
                    ...
                    <div className="col-span-1 md:col-span-2 max-w-full p-5 min-h-96 md:min-h-0 rounded-xl bg-white/65 shadow order-1 md:order-2">
                        <div>
                ...
                <div className="bg-white/65 p-4 rounded-xl shadow">
